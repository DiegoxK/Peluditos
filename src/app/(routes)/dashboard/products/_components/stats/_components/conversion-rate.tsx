  ...
  return (
    <Card className="relative">
      <CardTitle className="text-primary flex items-center gap-2">
        ...
        <span className="font-semibold">Tasa de conversión</span>
      </CardTitle>
      ...
      <CardContent>
        ...
        >
          <RadialBarChart
            ...
            startAngle={0}
            endAngle={
              ((chartData[0]?.sales ?? 0) * 360) / (chartData[0]?.views ?? 1)
            }
            innerRadius={80}
            outerRadius={110}
          >
