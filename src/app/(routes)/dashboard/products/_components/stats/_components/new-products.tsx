...
interface NewProductsAreaChartProps {
  registry: Record<string, { month: string; products: number }[]>;
}
...
export function NewProductsAreaChart({ registry }: NewProductsAreaChartProps) {
    ...
    <Card>
      <div className="flex justify-between">
        <CardTitle className="text-primary flex items-center gap-2">
          ...
          <span className="font-semibold">Nuevos productos</span>
        </CardTitle>
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        <CardDescription>
          Grafica de nuevos productos por mes de registro.
        </CardDescription>
      </CardFooter>
    </Card>
  );
